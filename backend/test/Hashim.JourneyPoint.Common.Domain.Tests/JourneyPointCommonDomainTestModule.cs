...
using Hashim.JourneyPoint.Tests.DependencyInjection;
using Shesha;
...
namespace Hashim.JourneyPoint.Common.Tests
{
    [DependsOn(
    ...
    public class JourneyPointCommonDomainTestModule : AbpModule
    {
        private string ConnectionString;

        public JourneyPointCommonDomainTestModule(SheshaNHibernateModule nhModule)
        {
